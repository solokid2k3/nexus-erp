package com.erp.desktop.api;

import com.erp.desktop.config.ApiConfig;
...
/**
 * Base HTTP client for communicating with the ERP REST API.
 * Handles JWT injection, JSON serialization, and async requests.
 */
